...
static_assert(static_cast<int>(GLFW::KeyModifiers::CAPS_LOCK) == GLFW_MOD_CAPS_LOCK, "CAPS_LOCK keyboard modifier bit does not match");
static_assert(static_cast<int>(GLFW::KeyModifiers::NUM_LOCK) == GLFW_MOD_NUM_LOCK, "NUM_LOCK keyboard modifier bit does not match");
...
static_assert(static_cast<int>(GLFW::KeyboardKey::LEFT_BRACKET) == GLFW_KEY_LEFT_BRACKET, "LEFT_BRACKET keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::BACKSLASH) == GLFW_KEY_BACKSLASH, "BACKSLASH keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::RIGHT_BRACKET) == GLFW_KEY_RIGHT_BRACKET, "RIGHT_BRACKET keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::GRAVE_ACCENT) == GLFW_KEY_GRAVE_ACCENT, "GRAVE_ACCENT keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::WORLD_1) == GLFW_KEY_WORLD_1, "WORLD_1 keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::WORLD_2) == GLFW_KEY_WORLD_2, "WORLD_2 keycode does not match");
...
static_assert(static_cast<int>(GLFW::KeyboardKey::DELETE) == GLFW_KEY_DELETE, "DELETE keycode does not match");
...
static_assert(static_cast<int>(GLFW::KeyboardKey::PAGE_UP) == GLFW_KEY_PAGE_UP, "PAGE_UP keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::PAGE_DOWN) == GLFW_KEY_PAGE_DOWN, "PAGE_DOWN keycode does not match");
...
static_assert(static_cast<int>(GLFW::KeyboardKey::CAPS_LOCK) == GLFW_KEY_CAPS_LOCK, "CAPS_LOCK keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::SCROLL_LOCK) == GLFW_KEY_SCROLL_LOCK, "SCROLL_LOCK keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::NUM_LOCK) == GLFW_KEY_NUM_LOCK, "NUM_LOCK keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::PRINT_SCREEN) == GLFW_KEY_PRINT_SCREEN, "PRINT_SCREEN keycode does not match");
...
static_assert(static_cast<int>(GLFW::KeyboardKey::KP_0) == GLFW_KEY_KP_0, "KP_0 keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::KP_1) == GLFW_KEY_KP_1, "KP_1 keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::KP_2) == GLFW_KEY_KP_2, "KP_2 keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::KP_3) == GLFW_KEY_KP_3, "KP_3 keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::KP_4) == GLFW_KEY_KP_4, "KP_4 keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::KP_5) == GLFW_KEY_KP_5, "KP_5 keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::KP_6) == GLFW_KEY_KP_6, "KP_6 keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::KP_7) == GLFW_KEY_KP_7, "KP_7 keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::KP_8) == GLFW_KEY_KP_8, "KP_8 keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::KP_9) == GLFW_KEY_KP_9, "KP_9 keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::KP_DECIMAL) == GLFW_KEY_KP_DECIMAL, "KP_DECIMAL keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::KP_DIVIDE) == GLFW_KEY_KP_DIVIDE, "KP_DIVIDE keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::KP_MULTIPLY) == GLFW_KEY_KP_MULTIPLY, "KP_MULTIPLY keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::KP_SUBTRACT) == GLFW_KEY_KP_SUBTRACT, "KP_SUBTRACT keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::KP_ADD) == GLFW_KEY_KP_ADD, "KP_ADD keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::KP_ENTER) == GLFW_KEY_KP_ENTER, "KP_ENTER keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::KP_EQUAL) == GLFW_KEY_KP_EQUAL, "KP_EQUAL keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::LEFT_SHIFT) == GLFW_KEY_LEFT_SHIFT, "LEFT_SHIFT keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::LEFT_CONTROL) == GLFW_KEY_LEFT_CONTROL, "LEFT_CONTROL keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::LEFT_ALT) == GLFW_KEY_LEFT_ALT, "LEFT_ALT keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::LEFT_SUPER) == GLFW_KEY_LEFT_SUPER, "LEFT_SUPER keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::RIGHT_SHIFT) == GLFW_KEY_RIGHT_SHIFT, "RIGHT_SHIFT keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::RIGHT_CONTROL) == GLFW_KEY_RIGHT_CONTROL, "RIGHT_CONTROL keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::RIGHT_ALT) == GLFW_KEY_RIGHT_ALT, "RIGHT_ALT keycode does not match");
static_assert(static_cast<int>(GLFW::KeyboardKey::RIGHT_SUPER) == GLFW_KEY_RIGHT_SUPER, "RIGHT_SUPER keycode does not match");
